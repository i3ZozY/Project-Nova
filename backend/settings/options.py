    ...
    SettingGroup(
        ...
        options=[
            SettingOption(
                ...
                option_type="toggle",
                description="Use the Steam client's language for Project Nova.",
                default=True,
            ...
            SettingOption(
                ...
                label="Language",
                option_type="select",
                description="Choose the language used by Project Nova.",
                default="en",
            ...
            SettingOption(
                ...
                option_type="text",
                description="API Key required to use Morrenus. Get from manifest.morrenus.xyz",
                default="",
