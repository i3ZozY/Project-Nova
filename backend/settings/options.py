    ...
    SettingGroup(
        ...
        options=[
            ...
            SettingOption(
                ...
                option_type="text",
                description="API Key required to use Morrenus source. Get from manifest.morrenus.xyz",
                default="",
            ...
            SettingOption(
                ...
                option_type="text",
                description="API Key for ManifestHub. Get from manifesthub1.filegear-sg.me",
                default="",
                metadata={"placeholder": "Enter your API key..."},
            ),
        ],
