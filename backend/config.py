"""Central configuration constants for the Project Nova backend."""

WEBKIT_DIR_NAME = "Project Nova"
WEB_UI_JS_FILE = "projectnova.js"
WEB_UI_ICON_FILE = "projectnova-icon.png"
